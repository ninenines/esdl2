...
ERLANG_MK_VERSION = 2.0.0-pre.1-69-g89dde87-dirty
...
ifeq ($(PLATFORM),msys2)
	C_SRC_OUTPUT_EXTENSION ?= .dll
else
	C_SRC_OUTPUT_EXTENSION ?= .so
endif

C_SRC_OUTPUT_FILE = $(C_SRC_OUTPUT)$(C_SRC_OUTPUT_EXTENSION)
